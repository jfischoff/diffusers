...
class StableDiffusionImageVariationTextPipeline(DiffusionPipeline):
    r"""
    ...
    def enable_sequential_cpu_offload(self, gpu_id=0):
        ...
        for cpu_offloaded_model in [self.unet, self.image_encoder, self.text_encoder, self.tokenizer, self.vae, self.safety_checker]:
    ...
    def __call__(
        ...
        Args:
            ...
            prompt (`str` or `List[str]`, *optional*):
                Optional prompt to guide the image generation.
